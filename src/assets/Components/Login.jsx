const Login = () => {
  return (
    <section className="login__container">
      ...
      <div className="login__container-login-inicio">
        <h2>Iniciar Sesión</h2>
        <form className="login__container-login-inicio-form">
          <input
            type="text"
          ...
          <input
            ...
            className="login__container-login-inicio-input"
          />
          <button type="submit" className="login__container-login-inicio-button">
            Iniciar Sesión
          </button>
        </form>
      ...
      <form className="login__container-register-form">
        ...
        <input
          ...
          className="login__container-register-input"
        />
        <button type="submit" className="login__container-register-button">
          Registrarse
        </button>
      </form>
